...
import { DashboardSearchCommand } from '@/modules/common/components/header/dashboard-search-command';
import { HeaderActions } from '@/modules/common/components/header/header-actions';
import { AppSidebar } from '@/modules/common/components/sidebar/app-sidebar';
