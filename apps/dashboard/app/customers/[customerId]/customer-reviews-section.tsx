...
export function CustomerReviewsSection({ customerId }: CustomerReviewsSectionProps) {
  ...
  const queryParams = useMemo<AdminReviewListParams>(
    ...
    [columnFilters, customerId, globalFilter, pagination.pageIndex, pagination.pageSize],
  );
  const reviewsQuery = useQuery({
    queryKey: ['admin', 'reviews', 'customer-list', queryParams],
