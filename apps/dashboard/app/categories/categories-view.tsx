  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <PageViewHeader
          title="Danh mục"
          description="Bảng cây có tìm kiếm, lọc, phân trang; danh mục nổi bật tô đỏ nhạt, thu gọn bằng mũi tên. Tạo danh mục thêm cấp 1, menu ⋯ thêm danh mục con tối đa 3 cấp."
          descriptionClassName="mt-1 max-w-2xl"
        />
